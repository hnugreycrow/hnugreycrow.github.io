...
export const siteConfig: SiteConfig = {
	title: "hnugreycrow",
	subtitle: "欢迎来到我的博客",
	siteURL: "https://github.com/hnugreycrow/hnugreycrow.github.io/", // 请替换为你的站点URL，以斜杠结尾
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/luxiya.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "hnugreycrow",
	...
	links: [
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/hnugreycrow",
		}
	],
};
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://rococo-crostata-82a7eb.netlify.app/.netlify/functions/twikoo",
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "api_FR1nCDnY9VU1tNxEOU7gMtqTQe23XtG2", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-auto-track="false" data-website-id="dd906ef4-201c-41a7-b509-4d308eef10af"></script>
